...
#define DBL_MINA          2.2250738585072014e-308 // min positive value
...
float isqrt_safe_tpl(float op) { return 1.0 / sqrt(op + DBL_MINA); }
...
struct Ang3{
	...
	Ang3(const Matrix33& m)
	{
		...
		y = asin_tpl(maxa(-1.0, mina(1.0, -m.m20)));
